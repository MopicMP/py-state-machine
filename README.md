...
> Finite state machine in pure Python

[![PyPI version](https://badge.fury.io/py/py-state-machine.svg)](https://pypi.org/project/py-state-machine/)
...
# Basic usage
result = machine("your input here")
print(result)
```
...
result = machine("Hello World")

# Example 2: Batch processing
from py_state_machine import batch
